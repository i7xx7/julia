...
module.exports = {
	...
	async execute(interaction){
        ...
        const logChannelCreate = await interaction.guild.fetchAuditLogs({ type: AuditLogEvent.ChannelCreate })
        ...
        const reply = {
            ...
            fields: [
                ...
                },
                {
                    ...
                    value: ` \`\`\` Posição: ${entry.target.rawPosition}º \`\`\` `
                }
            ],
